...
session_start();
      ...
      if($_SESSION['ID_U'])
    {
        ...
        $sql = "INSERT INTO Carro (FK_Album,FK_Usuario) VALUES ($ID, $Usuario)" or die("NO QUERY");
 ...
 <head>
  ...
  <div class="container">
          ...
          <div class="thumnail">
            ...
            <img src="<?php echo $Imagen;?>" id="social" style="width: 250px; height: 250px;" class="img-resposive img-thumbnail">
        ...
        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6" >
          ...
          <h1 align="center">SU COMPRA A SIGO COMPLETADA</h1>
          ...
          <div>
            ...
            <a href="Vista_Carro.php"><button class="btn btn-success btn-lg" style="margin:0px 50px 50px 50px;">Carro</button></a>
